...
(function() {
  var Creatable, DocumentFragment, Element, TextNode, addAttributes, addChildren, containsClass, create, createFromMarkupArray, createHtml, curry, each, eachObj, emulatedDocument, error, extend, filter, find, index, isDomNode, keyValue, map, mergeAttributes, orderedGroup, parseSelectorAttributes, parseTagName, plugins, regexIdOrClass, regexIdOrClassSeparator, render, splice, splitOnce, toObject, typeOf, types,
    __slice = [].slice;
  ...
  */
  ...
  Creatable = (typeof exports !== "undefined" && exports !== null) && exports || (this.Creatable = {
